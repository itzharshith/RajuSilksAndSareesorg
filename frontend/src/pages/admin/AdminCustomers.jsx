          ...
          <div className="md:hidden divide-y divide-gray-100">
            {users.map((item) => (
              <div key={item._id} className="p-4 space-y-3 hover:bg-brand-cream/5 text-xs">
                <div className="flex items-center space-x-2.5">
                  <div className="h-8 w-8 bg-brand-blue/10 text-brand-blue rounded-full flex items-center justify-center font-bold font-serif border border-brand-creamText/20 shrink-0">
                    {item.name[0].toUpperCase()}
                  </div>
