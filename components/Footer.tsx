...
export default function Footer() {
  return (
    <footer className="bg-brand-blue-deep text-brand-cream border-t border-brand-cream-text/30">
      
      {/* Top Banner (Value Propositions) */}
      <div className="border-b border-brand-cream-text/15 py-8 bg-brand-blue/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="flex flex-col items-center border-y md:border-y-0 md:border-x border-brand-cream-text/15 py-4 md:py-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs text-brand-cream/75">
            <li>
              <Link href="/shop?category=Kanjeevaram%20Silks" className="hover:text-brand-cream-text hover:underline transition-all">
                Kanjeevaram Silks
              </Link>
            </li>
            <li>
              <Link href="/shop?category=Pure%20Silks" className="hover:text-brand-cream-text hover:underline transition-all">
                Pure Silks
              </Link>
            </li>
            <li>
              <Link href="/shop?category=Bridal%20Collection" className="hover:text-brand-cream-text hover:underline transition-all">
                Bridal Collection
              </Link>
            </li>
            <li>
              <Link href="/shop?category=Soft%20Silks" className="hover:text-brand-cream-text hover:underline transition-all">
                Soft Silks
              </Link>
            </li>
            <li>
              <Link href="/shop?category=Banaras%20Sarees" className="hover:text-brand-cream-text hover:underline transition-all">
                Banaras Sarees
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs text-brand-cream/75">
            <li>
              <Link href="/about" className="hover:text-brand-cream-text hover:underline transition-all">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/contact" className="hover:text-brand-cream-text hover:underline transition-all">
                Contact Us
              </Link>
            </li>
            <li>
              <Link href="/terms" className="hover:text-brand-cream-text hover:underline transition-all">
                Terms & Conditions
              </Link>
            </li>
            <li>
              <Link href="/privacy" className="hover:text-brand-cream-text hover:underline transition-all">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/refund-policy" className="hover:text-brand-cream-text hover:underline transition-all">
                Refund & Cancellation Policy
              </Link>
            </li>
            <li>
              <Link href="/shipping-policy" className="hover:text-brand-cream-text hover:underline transition-all">
      ...
      {/* Copyright Bar */}
      <div className="bg-brand-blue-deep py-6 border-t border-brand-cream-text/15 text-center text-xs text-brand-cream/40">
